...
func (s *Server) GetStudent(ctx context.Context, req *pb.GetStudentRequest) (*pb.Student, error) {
...
func (s *Server) CreateStudent(ctx context.Context, req *pb.Student) (*pb.StudentResponse, error) {
